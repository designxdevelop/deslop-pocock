...
> **Deslop fork** of [mattpocock/skills](https://github.com/mattpocock/skills). Tracks upstream `main` and republishes whenever that set changes. Em dashes are replaced with ordinary punctuation. Not affiliated with Matt Pocock.

[![skills.sh](https://skills.sh/b/designxdevelop/deslop-pocock)](https://skills.sh/designxdevelop/deslop-pocock)
